...
// // //   return (
// // //     <section id="fee-calculator" className="w-full py-12 md:py-24 lg:py-8 bg-blue-50">
...
//   return (
//     <section id="fee-calculator" className="w-full py-12 md:py-24 lg:py-8 bg-white">
//       <div className="container mx-auto px-4">
//         <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
//           <div className="space-y-2">
//             <div className="inline-block rounded-lg bg-blue-100 px-3 py-1 text-sm text-blue-600">Smart Investment</div>
