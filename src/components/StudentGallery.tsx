...
export default function StudentGallery() {
  ...
  const scholarshipData = {
    mainScholarship: {
      percentage: "100%", // Updated to 100%
      amount: "₹15,000",
      period: "per year",
      type: "Corporate Scholarship",
      // Eligibility array removed
      benefits: [
        "Guaranteed Tuition fee reduction",
        "Free laptop kit included",
        "Sports kit for athletes",
        "Library membership included",
              ...
              <div className="relative bg-gradient-to-r from-green-600/20 to-emerald-600/20 backdrop-blur-sm rounded-3xl p-8 border border-green-500/30 overflow-hidden">
                ...
                <div className="relative grid lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-gray-300 text-lg">
                      BIMSR offers comprehensive corporate scholarships available to <span className="text-white font-bold">all students</span>, ensuring that quality education and resources are accessible to everyone without barriers.
                    </p>
                  ...
                  {/* Right - Benefits (Eligibility Removed) */}
                  <div className="space-y-6">
                    {/* Benefits Only */}
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 h-full flex flex-col justify-center">
                      ...
                      <ul className="space-y-3">
                        {scholarshipData.mainScholarship.benefits.map((item, index) => (
                          <li key={index} className="flex items-center text-gray-300">
                            <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center mr-3 shrink-0">
